...
if __name__ == "__main__":
    ...
    ar_marker_wrist_pub = rospy.Publisher("ar_marker_wrist_status", Float64MultiArray, queue_size=1)
    ar_marker_sub = rospy.Subscriber("/ar_pose_marker", AlvarMarkers, ar_marker_cb, queue_size=1)

...
def train_prob_sim(save_model=True):
    ...
    train_path = "./data/prob_pred/bayes_prob_branching_processed_feats_ts01_safe.h5"
    ...
    val_path = "./data/prob_pred/bayes_prob_branching_processed_val_feats_ts01_safe.h5"
